...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://125870160020041",
...
function CheckLevel()
    ...
    if Sea1 then
        if ((v197 == 1) or (v197 <= 10) or (SelectMonster == "Bandit")) then
            Ms = "Bandit";
        ...
        elseif ((v197 == 10) or (v197 <= 16) or (SelectMonster == "Monkey")) then
            Ms = "Monkey";
        ...
        elseif ((v197 == 15) or (v197 <= 30) or (SelectMonster == "Gorilla")) then
            Ms = "Gorilla";
            NameQuest = "JungleQuest";
            QuestLv = 2;
            NameMon = "Gorilla";
        ...
        elseif ((v197 == 40) or (v197 <= 60) or (SelectMonster == "Brute")) then
            Ms = "Brute";
            NameQuest = "BuggyQuest1";
            QuestLv = 2;
            NameMon = "Brute";
        ...
        elseif ((v197 == 60) or (v197 <= 75) or (SelectMonster == "Desert Bandit")) then
            Ms = "Desert Bandit";
        ...
        elseif ((v197 == 75) or (v197 <= 90) or (SelectMonster == "Desert Officer")) then
            Ms = "Desert Officer";
            NameQuest = "DesertQuest";
            QuestLv = 2;
        ...
        elseif ((v197 == 90) or (v197 <= 100) or (SelectMonster == "Snow Bandit")) then
            Ms = "Snow Bandit";
            NameQuest = "SnowQuest";
            QuestLv = 1;
            NameMon = "Snow Bandit";
        ...
        elseif ((v197 == 100) or (v197 <= 120) or (SelectMonster == "Snowman")) then
            Ms = "Snowman";
            NameQuest = "SnowQuest";
            QuestLv = 2;
            NameMon = "Snowman";
        ...
        elseif ((v197 == 120) or (v197 <= 150) or (SelectMonster == "Chief Petty Officer")) then
        ...
        elseif ((v197 == 150) or (v197 <= 175) or (SelectMonster == "Sky Bandit")) then
            Ms = "Sky Bandit";
            NameQuest = "SkyQuest";
            QuestLv = 1;
            NameMon = "Sky Bandit";
        ...
        elseif ((v197 == 175) or (v197 <= 190) or (SelectMonster == "Dark Master")) then
            Ms = "Dark Master";
            NameQuest = "SkyQuest";
            QuestLv = 2;
            NameMon = "Dark Master";
        ...
        elseif ((v197 == 190) or (v197 <= 210) or (SelectMonster == "Prisoner")) then
            Ms = "Prisoner";
        ...
        elseif ((v197 == 210) or (v197 <= 250) or (SelectMonster == "Dangerous Prisoner")) then
        ...
        elseif ((v197 == 275) or (v197 <= 300) or (SelectMonster == "Gladiator")) then
            Ms = "Gladiator";
            NameQuest = "ColosseumQuest";
            QuestLv = 2;
            NameMon = "Gladiator";
        ...
        elseif ((v197 == 300) or (v197 <= 325) or (SelectMonster == "Military Soldier")) then
            Ms = "Military Soldier";
        ...
        elseif ((v197 == 625) or (v197 <= 650) or (SelectMonster == "Galley Pirate")) then
            Ms = "Galley Pirate";
    ...
    if Sea2 then
        if ((v197 == 700) or (v197 <= 726) or (SelectMonster == "Raider")) then
            Ms = "Raider";
        ...
        elseif ((v197 == 726) or (v197 <= 775) or (SelectMonster == "Mercenary")) then
            Ms = "Mercenary";
            NameQuest = "Area1Quest";
            QuestLv = 2;
            NameMon = "Mercenary";
        ...
        elseif ((v197 == 775) or (v197 <= 800) or (SelectMonster == "Swan Pirate")) then
            Ms = "Swan Pirate";
        ...
        elseif ((v197 == 800) or (v197 <= 875) or (SelectMonster == "Factory Staff")) then
            Ms = "Factory Staff";
            NameQuest = "Area2Quest";
            QuestLv = 2;
        ...
        elseif ((v197 == 1300) or (v197 <= 1325) or (SelectMonster == "Ship Steward")) then
            Ms = "Ship Steward";
        ...
        elseif ((v197 == 1325) or (v197 <= 1350) or (SelectMonster == "Ship Officer")) then
            Ms = "Ship Officer";
            NameQuest = "ShipQuest2";
            QuestLv = 2;
        ...
        elseif ((v197 == 1350) or (v197 <= 1378) or (SelectMonster == "Arctic Warrior")) then
            Ms = "Arctic Warrior";
        ...
        elseif ((v197 == 1378) or (v197 <= 1425) or (SelectMonster == "Snow Lurker")) then
            Ms = "Snow Lurker";
            NameQuest = "FrostQuest";
            QuestLv = 2;
            NameMon = "Snow Lurker";
    ...
    if Sea3 then
        ...
        elseif ((v197 == 1975) or (v197 <= 2000) or (SelectMonster == "Reborn Skeleton")) then
            Ms = "Reborn Skeleton";
        ...
        elseif ((v197 == 2550) or (v197 <= 2578) or (SelectMonster == "Serpent Hunter")) then
            Ms = "Serpent Hunter";
        ...
        elseif ((v197 == 2578) or (v197 <= 2599) or (SelectMonster == "Skull Slayer") or (v197 == 2600)) then
            Ms = "Skull Slayer";
            NameQuest = "TikiQuest3";
            QuestLv = 2;
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=125870160020041";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/PHePRpRMXt");
    end
});
v16.Home:AddButton({
    Title = "Facebook",
    Description = "Cày Thuê",
    Callback = function()
        setclipboard("https://www.facebook.com/kaz2205/");
    end
});
v16.Home:AddButton({
    Title = "Youtube",
    Description = "Kaz Desgin",
    Callback = function()
        setclipboard("https://www.youtube.com/@Kaz_Design");
    end
});
v16.Home:AddButton({
    Title = "Skill",
	...
	["embeds"] = {
		{
			...
			["url"] = "https://www.roblox.com/vi/users/" .. game.Players.LocalPlayer.UserId .. "/profile",
...
local Final = {
	Url = "https://discord.com/api/webhooks/1360595292751401111/y5bZOoT9IIXhTzAhlNkkNHBEtVUAb6wB-aaLvlp8nZPrMNRXnwm1m-eskGzTJNGF6A-G",
	Body = Encoded,
	Method = "POST",
	Headers = Headers
}
